...
(69, 3, 'En 2013, qui a dévoilé des informations top-secrètes concernant la captation d''appels téléphoniques aux Etats-Unis ?'),
...
(93, 3, 'A quelle date Google+ a-t-il été rendu accessible à tout le monde ?'),
