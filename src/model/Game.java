...
//*******************************************************************************************
    ...
    private void createRooms() {
        ...
        Blanket b =  new Blanket("blanket", "You have to use it to escape.", 5, true, "/images/blanket.jpg");
        Ladder l = new Ladder("ladder", "You can climb the ladder.", 8, true, "/images/ladder.jpg");
