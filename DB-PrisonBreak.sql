...
INSERT INTO "QUESTION" ("ID", "RANK", "TITLE") VALUES(1, 1, 'Quellle est la premiËre Èmission de tÈlÈ-rÈalitÈ franÁaise ?'),(2, 3, 'Quelle Ètait la capacitÈ de stockage du premier IPOD en 2001 ?'),(3, 2, 'Quel est le nom du journal régionnal Vaudois ?')
