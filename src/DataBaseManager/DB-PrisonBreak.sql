<<<<<<< HEAD:src/DataBaseManager/DB-PrisonBreak.sql
  /*
  DROP TABLE ANSWER;
  DROP TABLE QUESTION;
  DROP TABLE GAME;
...
>>>>>>> onur:src/Quizz/QuestionsReponses.sql
...
(38, 1, 'A quelle marque appartient ce slogan : "Nous, c''Test le go�t" ?'),
...
(69, 3, 'En 2013, qui a d�voil� des informations top-secr�tes concernant la captation d''appels t�l�phoniques aux Etats-Unis ?'),
...
<<<<<<< HEAD:src/DataBaseManager/DB-PrisonBreak.sql
(84, 2, 'A quoi peut servir le peer-to-peer ?'),
...
(93, 3, 'A quelle date Google+ a-t-il �t� rendu accessible � tout le monde ?'),
...
(99, 2, 'A quoi servent les "Doodles" ? '),
